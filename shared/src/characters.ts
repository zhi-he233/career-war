...
export const characters: Record<CharacterId, Character> = {
  ...
  self_destructor: {
    ...
    name: "自爆人",
    maxHp: 20,
    description: ["6 点可选择发动自爆", "选择扣除自己 1 到 9 点血量，对目标造成扣血量 x2 的普通伤害"],
    difficulty: "complex",
    role: "burst",
    tags: ["攻击", "爆发", "高风险"],
    shortDescription: "用自己的血量换取爆发伤害。",
    fullDescription: ["自爆人最大血量 20。", "投到 6 时可以普通攻击造成 6 点伤害；也可以发动自爆：选择扣除自己 1 到 9 点血量，然后对目标造成扣血量 x2 的普通伤害，最高 18。", "扣血直接扣除自爆人血量，不经过自己的护盾；不能选择超过当前血量的扣血量。"],
    isImplemented: true
  },
  war_knight: {
    id: "war_knight",
  ...
  fire_lord: {
    ...
    name: "火焰领主",
    maxHp: 16,
    description: ["3 点可选择无伤并添加 1 层火焰印记", "攻击敌方时添加 1 层火焰印记", "6 点可选择爆发目标火焰印记，每层造成 3 点普通伤害并清空"],
    difficulty: "complex",
    role: "attack",
    tags: ["攻击", "印记", "爆发"],
    shortDescription: "通过叠加火焰印记制造爆发窗口。",
    fullDescription: ["火焰领主最大血量 16。", "投到 3 时可以普通攻击造成 3 点伤害并添加 1 层火焰印记；也可以发动技能，不造成伤害但添加 1 层火焰印记。", "每次普通攻击敌方时，给目标添加 1 层火焰印记。", "投到 6 时可以普通攻击造成 6 点伤害并添加 1 层火焰印记；也可以发动技能，爆发目标身上的火焰印记，每层造成 3 点普通伤害，爆发后清空目标火焰印记。"],
    isImplemented: true
  },
  mountain_shield: {
    id: "mountain_shield",
