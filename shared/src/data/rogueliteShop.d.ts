...
export declare const ROGUELITE_ACTIVE_SHOP_ITEM_IDS: readonly ["minor_healing_potion", "large_healing_potion", "shield_patch", "iron_plate", "spiked_gauntlet", "blood_vial", "lucky_dice", "skill_scroll", "cleansing_salt", "blacksmith_hammer", "reroll_coupon", "cracked_relic_box", "opening_bell"];
